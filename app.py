...
# ==========================================
# CẤU TRÚC TAB 1: OVERVIEW HEALTH SCORECARD
# ==========================================

st.markdown("""
<style>
    /* CSS Chung cho Tab Overview */
    .overview-container {
    ...
    .kpi-card-black { border-left: 6px solid #333333; }
    .kpi-card-green { border-left: 6px solid #2e7d32; }
    .kpi-card-yellow { border-left: 6px solid #f57c00; }
    .kpi-card-red { border-left: 6px solid #c62828; }

    .kpi-title { font-size: 11px; font-weight: bold; color: #555; text-transform: uppercase; }
    .kpi-value { font-size: 32px; font-weight: 700; line-height: 1; margin-top: 6px; }
    .kpi-subtext { font-size: 11px; color: #777; }

    .val-black { color: #222; }
    .val-green { color: #2e7d32; }
    .val-yellow { color: #f57c00; }
    .val-red { color: #c62828; }
</style>
""", unsafe_allow_html=True)

# 1. TIÊU ĐỀ
st.markdown('<div class="sub-header">MÀN HÌNH MỜ ĐẦU MỖI NGÀY</div>', unsafe_allow_html=True)
st.markdown('<div class="main-title">Health Scorecard tổng hợp Khách hàng lớn</div>', unsafe_allow_html=True)
...
with col1:
    ...
    <div class="kpi-card kpi-card-black">
        <div>
            ...
            <div class="kpi-value val-black">30</div>
        </div>
        <div class="kpi-subtext">Đang hiển thị mẫu 10</div>
    </div>
    """, unsafe_allow_html=True)
...
with col2:
    ...
    <div class="kpi-card kpi-card-green">
        <div>
            <div class="kpi-title" style="color:#2e7d32;">ỔN ĐỊNH (XANH)</div>
            <div class="kpi-value val-green">20</div>
        </div>
        <div class="kpi-subtext">Đạt mục tiêu</div>
    </div>
    """, unsafe_allow_html=True)
...
with col3:
    ...
    <div class="kpi-card kpi-card-yellow">
        <div>
            <div class="kpi-title" style="color:#f57c00;">CẢNH BÁO (VÀNG)</div>
            <div class="kpi-value val-yellow">7</div>
        </div>
        <div class="kpi-subtext">Cần theo dõi sát</div>
    </div>
    """, unsafe_allow_html=True)
...
with col4:
    ...
    <div class="kpi-card kpi-card-red">
        <div>
            ...
            <div class="kpi-value val-red">3</div>
        </div>
        <div class="kpi-subtext">Cần xử lý ngay</div>
    </div>
    """, unsafe_allow_html=True)

st.write("") # Khoảng trống

# 3. BẢNG DỮ LIỆU HEALTH SCORECARD & 2 BẢNG CHÚ THÍCH (GIAO DIỆN HTML/CSS CHUẨN)
html_overview_content = """
<!DOCTYPE html>
<html>
<head>
<style>
    ...
    .txt-yellow { color: #f57c00; font-weight: bold; }
    .txt-red { color: #c62828; font-weight: bold; }
...
<body>
    ...
    <!-- Group Header cho 7 ngày gần nhất -->
    <div class="group-header-container">
        <div class="group-header-box">Thực hiện trung bình 7 ngày gần nhất</div>
    </div>
    ...
    <table class="tbl-main">
        <thead>
            <tr>
                ...
                <th style="width: 10%;">Doanh thu mục tiêu FM</th>
                <th style="width: 9%;">Doanh thu D</th>
                <th style="width: 9%;">Doanh thu MTD</th>
                <th style="width: 10%;">% Doanh thu MTD/mục tiêu</th>
                <th style="width: 9%;">Doanh thu Δ WTD</th>
                <th style="width: 9%;">OPR (%)</th>
                <th style="width: 9%;">ODR (%)</th>
                <th style="width: 9%;">FD (%)</th>
                <th class="th-red" style="width: 14%;">Sức khỏe Khách hàng</th>
            </tr>
        </thead>
        <tbody>
            <tr class="row-green">
                <td class="txt-bold" style="text-align: left; padding-left: 8px;">TIKTOK</td>
                <td>100</td><td>22.30</td><td>22.30</td>
                <td class="txt-green">1.1%</td>
                <td class="txt-green">+6.8%</td>
                <td class="txt-green">91.2%</td>
                <td class="txt-green">92.5%</td>
                <td class="txt-green">96.8%</td>
                <td class="txt-green">TỐT</td>
            </tr>
            <tr class="row-yellow">
                <td class="txt-bold" style="text-align: left; padding-left: 8px;">SHOPEE</td>
                <td>100</td><td>22.30</td><td>22.30</td>
                <td class="txt-yellow">2.1%</td>
                <td class="txt-red">-3.4%</td>
                <td class="txt-green">85.6%</td>
                <td class="txt-yellow">88.9%</td>
                <td class="txt-green">93.1%</td>
                <td class="txt-yellow">CẢNH BÁO</td>
            </tr>
            <tr class="row-red">
                <td class="txt-bold" style="text-align: left; padding-left: 8px;">KH813</td>
                <td>100</td><td>22.30</td><td>22.30</td>
                <td class="txt-red">4.8%</td>
                <td class="txt-red">-14.5%</td>
                <td class="txt-red">74.2%</td>
                <td class="txt-yellow">82.1%</td>
                <td class="txt-red">79.5%</td>
                <td class="txt-red">RỦI RO</td>
            </tr>
            <tr class="row-green">
                <td class="txt-bold" style="text-align: left; padding-left: 8px;">TMM13</td>
                <td>100</td><td>22.30</td><td>22.30</td>
                <td class="txt-green">0.9%</td>
                <td class="txt-green">+10.4%</td>
                <td class="txt-green">93.4%</td>
                <td class="txt-green">94.0%</td>
                <td class="txt-green">95.2%</td>
                <td class="txt-green">TỐT</td>
            </tr>
            <tr class="row-yellow">
                <td class="txt-bold" style="text-align: left; padding-left: 8px;">TTQ123</td>
                <td>100</td><td>22.30</td><td>22.30</td>
                <td class="txt-yellow">1.8%</td>
                <td class="txt-green">+5.8%</td>
                <td class="txt-yellow">86.3%</td>
                <td class="txt-green">91.0%</td>
                <td class="txt-green">92.4%</td>
                <td class="txt-yellow">CẢNH BÁO</td>
            </tr>
            <tr class="row-red">
                <td class="txt-bold" style="text-align: left; padding-left: 8px;">TTQ124</td>
                <td>100</td><td>22.30</td><td>22.30</td>
                <td class="txt-red">3.4%</td>
                <td class="txt-red">-10.3%</td>
                <td class="txt-red">78.1%</td>
                <td class="txt-red">74.8%</td>
                <td class="txt-yellow">85.0%</td>
                <td class="txt-red">RỦI RO</td>
            </tr>
            <tr class="row-yellow">
                <td class="txt-bold" style="text-align: left; padding-left: 8px;">TTQ125</td>
                <td>100</td><td>22.30</td><td>22.30</td>
                <td class="txt-yellow">2.4%</td>
                <td class="txt-red">-0.6%</td>
                <td class="txt-yellow">84.2%</td>
                <td class="txt-yellow">85.9%</td>
                <td class="txt-yellow">87.1%</td>
                <td class="txt-yellow">CẢNH BÁO</td>
            </tr>
            <tr class="row-yellow">
                <td class="txt-bold" style="text-align: left; padding-left: 8px;">TTQ126</td>
                <td>100</td><td>22.30</td><td>22.30</td>
                <td class="txt-yellow">1.6%</td>
                <td class="txt-green">+3.7%</td>
                <td class="txt-yellow">89.9%</td>
                <td class="txt-green">92.1%</td>
                <td class="txt-green">90.5%</td>
                <td class="txt-yellow">CẢNH BÁO</td>
            </tr>
            <tr class="row-green">
                <td class="txt-bold" style="text-align: left; padding-left: 8px;">TTQ127</td>
                <td>100</td><td>22.30</td><td>22.30</td>
                <td class="txt-green">0.7%</td>
                <td class="txt-green">+13.7%</td>
                <td class="txt-green">95.1%</td>
                <td class="txt-green">96.3%</td>
                <td class="txt-green">97.0%</td>
                <td class="txt-green">TỐT</td>
            </tr>
            <tr class="row-red">
                <td class="txt-bold" style="text-align: left; padding-left: 8px;">TTQ128</td>
                <td>100</td><td>22.30</td><td>22.30</td>
                <td class="txt-red">3.1%</td>
                <td class="txt-green">+1.6%</td>
                <td class="txt-yellow">81.4%</td>
                <td class="txt-red">76.2%</td>
                <td class="txt-red">79.8%</td>
                <td class="txt-red">RỦI RO</td>
            </tr>
        </tbody>
    </table>

    <!-- 2 Bảng Chú Thích Quy Tắc (Rules) Phía Dưới -->
    <div class="legend-container">
        <!-- Bảng Left Legend -->
        <table class="legend-tbl">
            <thead>
                <tr>
                    <th style="width: 30%;">CẢNH BÁO</th>
                    <th style="width: 70%;">RULE</th>
                </tr>
            </thead>
            <tbody>
                <tr class="row-green">
                    <td class="txt-bold txt-green">Xanh - tốt</td>
                    <td>Chỉ số thực hiện lớn hơn so với mục tiêu</td>
                </tr>
                <tr class="row-yellow">
                    <td class="txt-bold txt-yellow">Vàng – cảnh báo</td>
                    <td>Chỉ số thực hiện thực hiện ở mức 80 – 99.99% so với mục tiêu</td>
                </tr>
                <tr class="row-red">
                    <td class="txt-bold txt-red">Đỏ - rủi ro</td>
                    <td>Chỉ số thực hiện thực hiện dưới mức 80% so với mục tiêu</td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="legend-tbl">
            ...
            <tbody>
                <tr class="row-green">
                    <td class="txt-bold txt-green">TỐT</td>
                    <td>Cả 4 chỉ số (Doanh thu, OPR, ODR, FD) đều ở mức Xanh</td>
                </tr>
                <tr class="row-yellow">
                    <td class="txt-bold txt-yellow">CẢNH BÁO</td>
                    <td>Có ít nhất 1 chỉ số ở mức Vàng, và không có chỉ số nào ở mức Đỏ</td>
                </tr>
                <tr class="row-red">
                    <td class="txt-bold txt-red">RỦI RO</td>
                    <td>Có ít nhất 1 chỉ số ở mức Đỏ (worst-of theo bảng ngưỡng RAG)</td>
                </tr>
            </tbody>
        </table>
    </div>
...
components.html(html_overview_content, height=520, scrolling=False)
